...
| **Mutation Testing (Mutant)** | `rake mutant:pure` | ⭕ | - | ⭕ | Test Suite Rigor / Detection Power | Fault Injection / Mutation Analysis | Shallow tests, unasserted edge cases, and surviving mutant bugs in pure algorithms and coordinates logic. |
