  ...
  class Writer
    ...
    def generate_chart_xml(chart)
      ...
      unless no_axes
        ...
        if chart[:cat_axis_line_color] || chart[:cat_axis_fill] || chart[:cat_axis_line_dash]
          parts << "<c:spPr>"
        ...
        if chart[:val_axis_line_color] || chart[:val_axis_fill] || chart[:val_axis_line_dash]
          parts << "<c:spPr>"
