      ...
      drawing_parts.each do |dp|
        ...
        when :sp
          ...
          if shape[:text]
            ...
            body_pr_xml = if autofit_xml.empty?
                            "<a:bodyPr#{body_pr_attrs}/>"
                          else
                            "<a:bodyPr#{body_pr_attrs}>#{autofit_xml}</a:bodyPr>"
                          end
