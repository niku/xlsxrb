...
module Xlsxrb
  ...
  class Writer
    ...
    def generate_chart_xml(chart)
      ...
      parts << "</c:chart>"
      if chart[:chart_fill] || chart[:chart_line_color] || chart[:chart_line_dash]
        cs_sp = +""
