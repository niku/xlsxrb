// Validates that a writer-generated XLSX with serLines is valid.
...
if (!errors.Any())
{
    ...
    if (!xml.Contains("<c:serLines"))
    {
        Console.Error.WriteLine("SCENARIO_FAIL: missing <c:serLines> element");
    }
    else
    {
