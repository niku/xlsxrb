// Validates chart space line_dash (prstDash) in spPr.
...
try
{
    ...
    if (!chartXml.Contains("val=\"lgDash\""))
        throw new Exception("SCENARIO_FAIL: prstDash val=lgDash not found in chart XML");
