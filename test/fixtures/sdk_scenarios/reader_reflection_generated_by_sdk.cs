// Generates an XLSX with a shape that has a reflection effect (a:reflection in a:effectLst).
...
var reflection = new DocumentFormat.OpenXml.Drawing.Reflection
{
    BlurRadius = 12700L,
    StartOpacity = 40000,
    EndAlpha = 0,
    ...
    Direction = 5400000,
    VerticalRatio = -90000,
    Alignment = DocumentFormat.OpenXml.Drawing.RectangleAlignmentValues.BottomLeft,
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Reflection Shape"));
