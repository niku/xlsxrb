// Generates an XLSX with a shape that has a soft edge effect (a:softEdge in a:effectLst).
...
var softEdge = new DocumentFormat.OpenXml.Drawing.SoftEdge { Radius = 127000L };
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Soft Edge Shape"));
