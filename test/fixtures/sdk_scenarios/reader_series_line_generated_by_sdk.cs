// Generates an XLSX with a line chart where the series has line formatting (color + width).
...
var ln = new DocumentFormat.OpenXml.Drawing.Outline { Width = 38100 };
ln.Append(new DocumentFormat.OpenXml.Drawing.SolidFill(
    new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "FF5500" }));
spPr.Append(ln);
ser.Append(spPr);
