...
try
{
    ...
    stylesPart.Stylesheet = new Stylesheet(
        ...
        new CellStyleFormats(
            ...
            new CellFormat { NumberFormatId = 14, FontId = 0, FillId = 0, BorderId = 0 }
        ) { Count = 2 },
        new CellFormats(
            new CellFormat { NumberFormatId = 0, FontId = 0, FillId = 0, BorderId = 0, FormatId = 0 },
            new CellFormat { NumberFormatId = 0, FontId = 0, FillId = 0, BorderId = 0, FormatId = 1 }
        ) { Count = 2 },
        new CellStyles(
            new CellStyle { Name = "Normal", FormatId = 0, BuiltinId = 0 },
            new CellStyle { Name = "DateBase", FormatId = 1 }
        ) { Count = 2 }
    );
