// Validates tickLblSkip and tickMarkSkip elements on chart category axis.
...
try
{
    ...
    if (!chartXml.Contains("tickLblSkip"))
        throw new Exception("SCENARIO_FAIL: tickLblSkip not found in chart XML");
    if (!chartXml.Contains("tickMarkSkip"))
        throw new Exception("SCENARIO_FAIL: tickMarkSkip not found in chart XML");
