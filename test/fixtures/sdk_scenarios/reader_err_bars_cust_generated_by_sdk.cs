// Generates an XLSX with custom error bars having plus and minus numRef elements.
...
try
{
    ...
    wsPart.Worksheet = new Worksheet(new SheetData(
        new Row(new Cell { CellReference = "A1", DataType = CellValues.Number, CellValue = new CellValue("10") },
                new Cell { CellReference = "B1", DataType = CellValues.Number, CellValue = new CellValue("1.5") },
                new Cell { CellReference = "C1", DataType = CellValues.Number, CellValue = new CellValue("0.8") })
    ));
    ...
    <c:barChart>
      ...
      <c:ser>
        ...
        <c:errBars>
          ...
          <c:plus><c:numRef><c:f>Sheet1!$B$1</c:f></c:numRef></c:plus>
          <c:minus><c:numRef><c:f>Sheet1!$C$1</c:f></c:numRef></c:minus>
        </c:errBars>
      </c:ser>
      <c:axId val=""1""/>
      <c:axId val=""2""/>
