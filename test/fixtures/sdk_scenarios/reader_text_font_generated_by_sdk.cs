// Generates an XLSX with a shape that has text with font properties (bold, italic, size, color, name).
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Bold = true, Italic = true, FontSize = 1600 };
rPr.Append(new DocumentFormat.OpenXml.Drawing.SolidFill(
    new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "00CC00" }));
rPr.Append(new DocumentFormat.OpenXml.Drawing.LatinFont { Typeface = "Times New Roman" });

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Styled Text"));
