// Creates an XLSX with an image having line color and width via a:ln.
...
nvPicPr.Append(new DocumentFormat.OpenXml.Drawing.Spreadsheet.NonVisualDrawingProperties { Id = 2, Name = "Pic1" });
...
var outline = new DocumentFormat.OpenXml.Drawing.Outline { Width = 25400 };
var solidFillLine = new DocumentFormat.OpenXml.Drawing.SolidFill();
solidFillLine.Append(new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "FF0000" });
outline.Append(solidFillLine);
spPr.Append(outline);
pic.Append(spPr);
