// Generates an XLSX with a shape that has text with baseline attribute on a:rPr.
...
// TextBody with baseline attribute (superscript)
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Baseline = 30000 };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Super"));
