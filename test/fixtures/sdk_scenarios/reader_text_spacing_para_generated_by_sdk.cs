// Generates an XLSX with a shape that has paragraph spacing (spcBef/spcAft) in a:pPr.
...
// TextBody with paragraph spacing
...
pPr.Append(new DocumentFormat.OpenXml.Drawing.SpaceBefore(
    new DocumentFormat.OpenXml.Drawing.SpacingPoints { Val = 600 }));
pPr.Append(new DocumentFormat.OpenXml.Drawing.SpaceAfter(
    new DocumentFormat.OpenXml.Drawing.SpacingPoints { Val = 400 }));

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(new DocumentFormat.OpenXml.Drawing.RunProperties());
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Spaced"));
