// Validates that an XLSX shape bodyPr has rot attribute for text rotation.
...
try
{
    ...
    var rot = bodyPr.Rotation ?? throw new Exception("Rotation attribute is missing.");
    if (rot.Value != 2700000)
        throw new Exception($"Expected rot=2700000, got {rot.Value}.");
