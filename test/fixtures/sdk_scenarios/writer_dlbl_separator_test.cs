// Validates that a writer-generated XLSX with a dLbl containing separator is valid.
...
if (!errors.Any())
{
    ...
    if (!xml.Contains("<c:separator>"))
    {
        Console.Error.WriteLine("SCENARIO_FAIL: missing <c:separator> in dLbl");
    }
    else
    {
