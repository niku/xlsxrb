// Generates an XLSX with a shape that has vertical text direction on bodyPr.
...
// TextBody with vertical text direction
var txBody = new DocumentFormat.OpenXml.Drawing.Spreadsheet.TextBody();
txBody.Append(new DocumentFormat.OpenXml.Drawing.BodyProperties { Vertical = DocumentFormat.OpenXml.Drawing.TextVerticalValues.Vertical });
txBody.Append(new DocumentFormat.OpenXml.Drawing.ListStyle());

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Vertical"));
