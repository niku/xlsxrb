// Generates an XLSX with a roundRect shape that has adjust values.
...
sp.Append(new DocumentFormat.OpenXml.Drawing.Spreadsheet.NonVisualShapeProperties(
    new DocumentFormat.OpenXml.Drawing.Spreadsheet.NonVisualDrawingProperties { Id = 2u, Name = "RoundRect 1" },
    new DocumentFormat.OpenXml.Drawing.Spreadsheet.NonVisualShapeDrawingProperties()));

// SpPr with prstGeom + avLst
var prstGeom = new DocumentFormat.OpenXml.Drawing.PresetGeometry { Preset = DocumentFormat.OpenXml.Drawing.ShapeTypeValues.RoundRectangle };
var avLst = new DocumentFormat.OpenXml.Drawing.AdjustValueList();
avLst.Append(new DocumentFormat.OpenXml.Drawing.ShapeGuide { Name = "adj", Formula = "val 25000" });
avLst.Append(new DocumentFormat.OpenXml.Drawing.ShapeGuide { Name = "adj2", Formula = "val 50000" });
