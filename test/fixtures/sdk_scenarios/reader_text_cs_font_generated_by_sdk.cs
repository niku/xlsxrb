// Generates an XLSX with a shape that has text with a:cs Complex Script font in a:rPr.
...
rPr.Append(new DocumentFormat.OpenXml.Drawing.ComplexScriptFont { Typeface = "Arabic Typesetting" });

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Complex"));
