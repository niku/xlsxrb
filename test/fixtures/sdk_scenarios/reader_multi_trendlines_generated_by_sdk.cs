// Generates an XLSX with a line chart having two trendlines on a single series.
...
try
{
    ...
    wsPart.Worksheet = new Worksheet(new SheetData(
        new Row(new Cell { CellReference = "A1", DataType = CellValues.Number, CellValue = new CellValue("1") },
                new Cell { CellReference = "A2", DataType = CellValues.Number, CellValue = new CellValue("4") },
                new Cell { CellReference = "A3", DataType = CellValues.Number, CellValue = new CellValue("9") })
    ));
