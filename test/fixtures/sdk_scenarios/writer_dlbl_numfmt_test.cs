// Validates that a writer-generated XLSX with a dLbl containing numFmt is valid.
...
if (!errors.Any())
{
    ...
    if (!xml.Contains("<c:numFmt") || !xml.Contains("0.00%"))
    {
        Console.Error.WriteLine("SCENARIO_FAIL: missing <c:numFmt> with 0.00% in dLbl");
    }
    else
    {
