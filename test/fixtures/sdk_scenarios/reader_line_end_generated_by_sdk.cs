// Generates an XLSX with a shape that has a:headEnd and a:tailEnd in its line properties.
...
var ln = new DocumentFormat.OpenXml.Drawing.Outline { Width = 12700 };
ln.Append(new DocumentFormat.OpenXml.Drawing.SolidFill(
    new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "0000FF" }));
ln.Append(new DocumentFormat.OpenXml.Drawing.HeadEnd {
    Type = DocumentFormat.OpenXml.Drawing.LineEndValues.Diamond,
    Width = DocumentFormat.OpenXml.Drawing.LineEndWidthValues.Small,
    Length = DocumentFormat.OpenXml.Drawing.LineEndLengthValues.Small
});
ln.Append(new DocumentFormat.OpenXml.Drawing.TailEnd {
    Type = DocumentFormat.OpenXml.Drawing.LineEndValues.Arrow,
    Width = DocumentFormat.OpenXml.Drawing.LineEndWidthValues.Large,
    Length = DocumentFormat.OpenXml.Drawing.LineEndLengthValues.Medium
});
spPr.Append(ln);
sp.Append(spPr);
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Arrow Line"));
