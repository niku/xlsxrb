// Generates an XLSX with a bar3D chart with per-series shape overrides.
  ...
  <c:plotArea>
    ...
    <c:bar3DChart>
      ...
      <c:ser>
        <c:idx val=""1""/>
        <c:order val=""1""/>
        <c:val><c:numRef><c:f>Sheet1!$A$2</c:f></c:numRef></c:val>
        <c:shape val=""pyramid""/>
      </c:ser>
      <c:axId val=""1""/>
      <c:axId val=""2""/>
    ...
    <c:serAx><c:axId val=""3""/><c:scaling><c:orientation val=""minMax""/></c:scaling><c:delete val=""1""/><c:axPos val=""b""/><c:crossAx val=""2""/></c:serAx>
  </c:plotArea>
</c:chart>";
