// Generates an XLSX with line_dash (prstDash) on chart title and axis title spPr via InnerXml.
...
<c:chart xmlns:c=""http://schemas.openxmlformats.org/drawingml/2006/chart""
         xmlns:a=""http://schemas.openxmlformats.org/drawingml/2006/main"">
  <c:title>
    <c:tx><c:rich><a:bodyPr/><a:lstStyle/><a:p><a:r><a:t>My Chart</a:t></a:r></a:p></c:rich></c:tx>
    <c:overlay val=""0""/>
    <c:spPr>
      <a:ln>
  ...
  <c:plotArea>
    ...
    <c:catAx>
      ...
      <c:axPos val=""b""/>
      <c:title>
        <c:tx><c:rich><a:bodyPr/><a:lstStyle/><a:p><a:r><a:t>Category</a:t></a:r></a:p></c:rich></c:tx>
        <c:overlay val=""0""/>
        <c:spPr>
          <a:ln>
    ...
    <c:valAx>
      ...
      <c:axPos val=""l""/>
      <c:title>
        <c:tx><c:rich><a:bodyPr/><a:lstStyle/><a:p><a:r><a:t>Value</a:t></a:r></a:p></c:rich></c:tx>
        <c:overlay val=""0""/>
        <c:spPr>
          <a:ln>
