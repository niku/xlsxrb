// Generates an XLSX with a shape that has text with underline attribute on a:rPr.
...
// TextBody with underline attribute
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Underline = DocumentFormat.OpenXml.Drawing.TextUnderlineValues.Single };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Underlined"));
