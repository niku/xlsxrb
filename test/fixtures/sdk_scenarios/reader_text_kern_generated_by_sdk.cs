// Generates an XLSX with a shape that has text kerning via kern attribute on a:rPr.
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Kerning = 1200 };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Kerned"));
