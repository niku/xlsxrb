// Generates an XLSX with a line chart where the series has marker formatting (symbol + size).
...
// Marker with symbol and size
var marker = new DocumentFormat.OpenXml.Drawing.Charts.Marker();
marker.Append(new DocumentFormat.OpenXml.Drawing.Charts.Symbol { Val = DocumentFormat.OpenXml.Drawing.Charts.MarkerStyleValues.Triangle });
marker.Append(new DocumentFormat.OpenXml.Drawing.Charts.Size { Val = 10 });
ser.Append(marker);

ser.Append(new DocumentFormat.OpenXml.Drawing.Charts.Values(
    new DocumentFormat.OpenXml.Drawing.Charts.NumberReference(
        new DocumentFormat.OpenXml.Drawing.Charts.Formula("Sheet1!$A$1:$A$2"))));
