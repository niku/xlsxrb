// Generates an XLSX with a shape that has a glow effect (a:glow in a:effectLst).
...
var glow = new DocumentFormat.OpenXml.Drawing.Glow { Radius = 139700L };
glow.Append(new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "0000FF" });
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Glow Shape"));
