// Generates an XLSX with a shape that has text with cap attribute on a:rPr.
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Capital = DocumentFormat.OpenXml.Drawing.TextCapsValues.All };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("AllCaps"));
