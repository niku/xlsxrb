// Generates an XLSX with a shape that has an outer shadow (a:outerShdw in a:effectLst).
...
var outerShdw = new DocumentFormat.OpenXml.Drawing.OuterShadow
{
    BlurRadius = 63500L,
    Distance = 50800L,
    Direction = 5400000,
...
outerShdw.Append(new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "0000FF" });
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Shadow Shape"));
