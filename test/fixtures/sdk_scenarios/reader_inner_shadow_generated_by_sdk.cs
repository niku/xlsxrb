// Generates an XLSX with a shape that has an inner shadow (a:innerShdw in a:effectLst).
...
var innerShdw = new DocumentFormat.OpenXml.Drawing.InnerShadow
{
    BlurRadius = 76200L,
    Distance = 38100L,
    Direction = 2700000
};
innerShdw.Append(new DocumentFormat.OpenXml.Drawing.RgbColorModelHex { Val = "00FF00" });
effectLst.Append(innerShdw);
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Inner Shadow Shape"));
