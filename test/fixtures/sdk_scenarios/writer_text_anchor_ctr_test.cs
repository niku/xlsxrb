// Validates that an XLSX shape bodyPr has anchorCtr attribute.
...
try
{
    ...
    var anchorCtr = bodyPr.AnchorCenter ?? throw new Exception("AnchorCenter attribute is missing.");
    if (anchorCtr.Value != true)
        throw new Exception($"Expected anchorCtr=true, got {anchorCtr.Value}.");
