// Creates an XLSX with a shape having noFill and noLine (empty ln).
...
var noLineOutline = new DocumentFormat.OpenXml.Drawing.Outline();
noLineOutline.Append(new DocumentFormat.OpenXml.Drawing.NoFill());
