// Generates an XLSX with a shape that has text with lang attribute on a:rPr.
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Language = "en-US" };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Hello"));
