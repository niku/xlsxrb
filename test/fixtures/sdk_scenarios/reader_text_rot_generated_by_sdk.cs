// Generates an XLSX with a shape that has text rotation via rot attribute on a:bodyPr.
...
// TextBody with rot attribute on bodyPr
var txBody = new DocumentFormat.OpenXml.Drawing.Spreadsheet.TextBody();
txBody.Append(new DocumentFormat.OpenXml.Drawing.BodyProperties { Rotation = 2700000 });
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Rotated"));
...
// Reference the drawing from the worksheet
