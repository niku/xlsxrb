...
try
{
    ...
    // Set conformance via raw attribute since the SDK enum may not map string values directly
    workbookPart.Workbook.SetAttribute(new OpenXmlAttribute("", "conformance", null, "transitional"));
