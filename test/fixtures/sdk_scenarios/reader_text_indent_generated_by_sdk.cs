// Generates an XLSX with a shape that has paragraph indent/margins via marL, marR, indent on a:pPr.
...
// TextBody with paragraph indent/margins
...
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Indented"));
