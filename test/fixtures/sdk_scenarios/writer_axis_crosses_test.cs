// Validates that crosses elements are written on category and value axes.
...
try
{
    ...
    if (!chartXml.Contains("crosses"))
        throw new Exception("SCENARIO_FAIL: crosses element not found in chart XML");
    if (!chartXml.Contains("\"autoZero\""))
        throw new Exception("SCENARIO_FAIL: crosses val='autoZero' not found");
