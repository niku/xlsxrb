...
var phoneticPr = new PhoneticProperties() { FontId = 1, Type = PhoneticValues.Hiragana, Alignment = PhoneticAlignmentValues.Center };
worksheetPart.Worksheet = new Worksheet(sheetData, phoneticPr);
