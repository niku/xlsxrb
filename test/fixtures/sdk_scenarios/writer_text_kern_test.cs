// Validates that an XLSX shape text run has kern attribute on a:rPr.
...
try
{
    ...
    var kern = rPr.Kerning ?? throw new Exception("Kerning attribute is missing.");
    if (kern.Value != 1200)
        throw new Exception($"Expected kern=1200, got {kern.Value}.");
