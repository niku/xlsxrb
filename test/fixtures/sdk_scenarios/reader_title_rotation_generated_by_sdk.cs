// Generates an XLSX with title rotation for reader interoperability testing.
  ...
  <c:title>
    <c:tx>
      <c:rich>
        ...
        <a:lstStyle/>
        <a:p><a:r><a:t>Rotated Title</a:t></a:r></a:p>
      </c:rich>
    </c:tx>
    <c:overlay val=""0""/>
  </c:title>
      ...
      <c:title>
        <c:tx>
          <c:rich>
            ...
            <a:lstStyle/>
            <a:p><a:r><a:t>Cat Title</a:t></a:r></a:p>
          </c:rich>
        </c:tx>
        <c:overlay val=""0""/>
      </c:title>
      ...
      <c:title>
        <c:tx>
          <c:rich>
            <a:bodyPr rot=""0""/>
            <a:lstStyle/>
            <a:p><a:r><a:t>Val Title</a:t></a:r></a:p>
          </c:rich>
        </c:tx>
        <c:overlay val=""0""/>
      </c:title>
