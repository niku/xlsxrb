// Validates plot area background fill color on a chart.
...
try
{
    ...
    if (!chartXml.Contains("CCCCCC"))
        throw new Exception("SCENARIO_FAIL: plot area fill color CCCCCC not found in chart XML");
