// Generates an XLSX with a shape that has text with strike attribute on a:rPr.
...
// TextBody with strike attribute
...
var rPr = new DocumentFormat.OpenXml.Drawing.RunProperties { Strike = DocumentFormat.OpenXml.Drawing.TextStrikeValues.SingleStrike };

var run = new DocumentFormat.OpenXml.Drawing.Run();
run.Append(rPr);
run.Append(new DocumentFormat.OpenXml.Drawing.Text("Struck"));
