...
class ReaderInteroperabilityTest < Test::Unit::TestCase
  ...
  test "reader parses SDK-generated marker line dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated marker noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated marker no line" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text strike" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text underline" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text baseline" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text spacing" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text cap" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text paragraph alignment" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text run language" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text vertical direction" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text inset margins" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated chart with axis label rotation" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with East Asian font" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with Complex Script font" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text rotation" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with paragraph indent" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with text kerning" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with anchor center" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated shape with paragraph spacing" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated plot area line dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated plot area noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated data point no_line" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal(true, dp[:no_line])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated data point marker" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    ser = chart[:series][0]
    dp = ser[:data_points][0]
    assert_equal("diamond", dp[:marker_symbol])
    assert_equal(8, dp[:marker_size])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end
  ...
  test "reader parses SDK-generated data point marker noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    ser = chart[:series][0]
    dp = ser[:data_points][0]
    assert_equal("circle", dp[:marker_symbol])
    assert_equal(true, dp[:marker_no_fill])
    assert_equal(true, dp[:marker_no_line])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end
  ...
  test "reader parses SDK-generated shape with inner shadow" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_not_nil(is)
    assert_equal(76_200, is[:blur_rad])
    assert_equal(38_100, is[:dist])
    assert_equal(2_700_000, is[:dir])
    assert_equal("00FF00", is[:color])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated shape with glow effect" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    gl = shapes[0][:glow]
    assert_not_nil(gl)
    assert_equal(139_700, gl[:rad])
    assert_equal("0000FF", gl[:color])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated shape with soft edge effect" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated chart series with line cap and join" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal("bevel", ser[:line_join])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated chart space fill and border" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated chart space line dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated title line dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated axis title noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated axis fill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated axis noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated axis line dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal("00FF00", chart[:val_axis_line_color])
    assert_equal("dashDot", chart[:val_axis_line_dash])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated plot area manual layout" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal("edge", layout[:x_mode])
    assert_equal("edge", layout[:y_mode])
    assert_in_delta(0.15, layout[:x], 0.001)
    assert_in_delta(0.1, layout[:y], 0.001)
    assert_in_delta(0.75, layout[:w], 0.001)
    assert_in_delta(0.65, layout[:h], 0.001)
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated legend entry font" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal(true, font[:bold])
    assert_equal(true, font[:italic])
    assert_equal("Calibri", font[:name])
    assert_equal("FF0000", font[:color])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated title and data point noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated up/down bars noFill" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated legend and data table line_dash" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated dLbl custom text" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal("SDK Custom", dlbl[:text])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated dLbl delete" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    ser = chart[:series][0]
    dlbl = ser[:data_labels][:labels][0]
    assert_equal(1, dlbl[:idx])
    assert_equal(true, dlbl[:delete])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated dLbl numFmt" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    dlbl = ser[:data_labels][:labels][0]
    assert_equal(0, dlbl[:idx])
    assert_equal("0.00%", dlbl[:num_fmt][:format_code])
    assert_equal(true, dlbl[:num_fmt][:source_linked])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated dLbl separator" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    dlbl = ser[:data_labels][:labels][0]
    assert_equal(0, dlbl[:idx])
    assert_equal(" | ", dlbl[:separator])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated dLbl spPr" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    dlbl = ser[:data_labels][:labels][0]
    assert_equal(0, dlbl[:idx])
    assert_equal("FFCC00", dlbl[:fill_color])
    assert_equal("333333", dlbl[:line_color])
    assert_equal(1.5, dlbl[:line_width])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end
  ...
  test "reader parses SDK-generated serLines" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_instance_of(Hash, ser_lines)
    assert_equal("888888", ser_lines[:line_color])
    assert_equal(1.0, ser_lines[:line_width])
    assert_equal("dash", ser_lines[:line_dash])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end
  ...
  test "reader parses SDK-generated trendlineLbl" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    nf = tl[:label][:num_fmt]
    assert_not_nil(nf)
    assert_equal("0.000", nf[:format_code])
    assert_equal(false, nf[:source_linked])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated dispUnitsLbl" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    nf = du[:label][:num_fmt]
    assert_not_nil(nf)
    assert_equal("#,##0.0", nf[:format_code])
    assert_equal(false, nf[:source_linked])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated ofPieChart" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal(2, chart[:split_pos])
    assert_equal(80, chart[:second_pie_size])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated custSplit" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
    ...
    assert_equal([0, 2], chart[:cust_split])
    assert_equal(75, chart[:second_pie_size])
  ensure
    File.delete(xlsx_path) if xlsx_path && File.exist?(xlsx_path)
  end

  test "reader parses SDK-generated custom error bars with plus and minus" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated per-series shape" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated title styling" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated surface3DChart" do
    xlsx_tempfile = Tempfile.new(["xlsxrb-reader-e2e", ".xlsx"])
    xlsx_path = xlsx_tempfile.path
    xlsx_tempfile.close
  ...
  test "reader parses SDK-generated chart-level default font" do
    xlsx_path = File.join(Dir.tmpdir, "reader_chart_font_#{Process.pid}.xlsx")
